...
public class BookControllerIntegrationTests {
    ...
    public void testThatListBooksReturnsBook() throws Exception {
        ...
        mockMvc.perform(
                ...
                MockMvcResultMatchers.jsonPath("$[0].isbn").value("978-0-13-449416-6")
        ).andExpect(
                MockMvcResultMatchers.jsonPath("$[0].title").value("The Pragmatic Programmer: Your Journey to Mastery")
        );
    }
